 ...
 * @author hasvm
 */
public class GearsMenu extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GearsMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
