 ...
 * @author hasvm
 */
public class RimsMenu extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RimsMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
