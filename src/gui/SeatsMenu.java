 ...
 * @author hasvm
 */
public class SeatsMenu extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeatsMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
